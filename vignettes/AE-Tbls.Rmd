...
```{r dddata1}
t1 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata2}
t2 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata3}
t3 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(gsub("\\s+", "",STACKVAR) != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata5}
t5 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(SYSPREF != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata6}
t6 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata7}
t7 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata8}
t8 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(gsub("\\s+", "", STACKVAR) != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata9}
t9 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(gsub("\\s+", "", STACKVAR) != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata10}
t10 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(gsub("\\s+", "", STACKVAR) != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata11}
t11 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(gsub("\\s+", "", STACKVAR) != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata12}
t12 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata13}
t13 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
...
```{r dddata14}
t14 <- readRDS(rfenv$G_DDDATA) %>% dplyr::filter(AEDECOD != '') %>% dplyr::filter(row_number()<=50)
