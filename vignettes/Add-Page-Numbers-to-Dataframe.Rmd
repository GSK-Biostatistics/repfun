...
rfenv$G_POPDATA %>% mutate(TRT01AN=ifelse(TRT01A=='Placebo',1,ifelse(TRT01A=='Xanomeline Low Dose',2,3))) %>% 
...
knitr::kable(head(aesum_p1,40), col.names=paste(names(lbls),lbls,sep=": "),
...
knitr::kable(
  head(aesum_p2,40), col.names=paste(names(lbls),lbls,sep=": "),
...
knitr::kable(
  head(aesum_p3,90), col.names=paste(names(lbls),lbls,sep=": "),
...
```{r cleanup}
#unlink("../docs/articles/Add-Page-Numbers-to-Dataframe_files", recursive = TRUE)
```
